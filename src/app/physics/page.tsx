                ...
                <Card className="mx-auto w-full backdrop-blur-md md:w-[70%]">
                    ...
                    <CardHeader className="pt-0">
                        ...
                        <CardDescription>
                            ...
                            is a set of three ordinary differential equations first developed by
                            Edward Lorenz while studying atmospheric convection. The system can
                            exhibit chaotic behavior, meaning its output can be highly sensitive to
                            small changes in its starting conditions.
                            <br />
                            <br />
                            This real-time simulation is powered by a Go microservice that streams
                            data to an ASP.NET backend using gRPC.
                        </CardDescription>
                    </CardHeader>
                </Card>
            </div>
